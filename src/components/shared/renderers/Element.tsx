...
interface ElementProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> {
	content: any,
	children?: ReactNode,
...
const Element: FC<ElementProps> = ({type, content, ...props}) => {
	...
	return React.createElement(type, props, props.children ?? content);
};
