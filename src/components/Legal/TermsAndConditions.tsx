    ...
    <div>
      <Link href="/">
        <div className="flex items-center justify-center gap-3 mt-8 mb-8">
          ...
          <p className="text-3xl md:text-4xl font-medium text-white font-giasyr">
            Arti AI
          </p>
        </div>
      </Link>
      <h2 className="font-medium text-4xl mt-5 mb-3 text-left font-gilroyRegular w-full max-w-[1000px] mx-auto px-5">
        Terms and Conditions
      </h2>
      <div className="w-full font-diatype max-w-[1000px] mx-auto p-5">
        <p className="text-sm leading-[2] tracking-wider">
          Agreement between User and Arti AI Welcome to ArtiAI.com. The
          ArtiAI.com website (the “Site”) is comprised of various web pages
          operated by Arti AI. ArtiAI.com is offered to you conditioned on your
          acceptance without modification of the terms, conditions, and notices
          contained herein (the “Terms”). Your use of ArtiAI.com constitutes
          your agreement to all such Terms. Please read these terms carefully,
          and keep a copy of them for your reference. ArtiAI.com is a Company
          Site. Describe the purpose of your website Privacy Your use of
          ArtiAI.com is subject to Arti AI's Privacy Policy. Please review our
          Privacy Policy, which also governs the Site and informs users of our
          data collection practices. Electronic Communications Visiting
          ArtiAI.com or sending emails to Arti AI constitutes electronic
          communications.
        </p>{" "}
        <p className="text-sm leading-[2] tracking-wider">
          ...
          entity. You acknowledge that Arti AI is not responsible for third
          party access to your account that results from theft or
          misappropriation of your account. Arti AI and its associates reserve
          the right to refuse or cancel service, terminate accounts, or remove
          or edit content in our sole discretion. Children Under Thirteen Arti
          AI does not knowingly collect, either online or offline, personal
          information from persons under the age of thirteen.
        </p>{" "}
        <p className="text-sm leading-[2] tracking-wider">
          If you are under 18, you may use ArtiAI.com only with permission of a
          parent or guardian. Links to Third Party Sites/Third Party Services
          ArtiAI.com may contain links to other websites (“Linked Sites”). The
          Linked Sites are not under the control of Arti AI and Arti AI is not
          ...
          updates to a Linked Site. Arti AI is providing these links to you only
          as a convenience, and the inclusion of any link does not imply
          endorsement by Arti AI the site or any association with its operators.
          Certain services made available via ArtiAI.com are delivered by third
          party sites and organizations.
        </p>
        <p className="text-sm leading-[2] tracking-wider">
          By using any product, service or functionality originating from the
          ArtiAI.com domain, you hereby acknowledge and consent that Arti AI may
          share such information and data with any third party with whom Arti AI
          has a contractual relationship to provide the requested product,
          service or functionality on behalf of ArtiAI.com users and customers.
          ...
          ArtiAI.com strictly in accordance with these terms of use. As a
          condition of your use of the Site, you warrant to Arti AI that you
          ...
          used on the Site, is the property of Arti AI or its suppliers and
        ...
        notices, legends or other restrictions contained in any such content and
        ...
        in part, found on the Site. Arti AI's content is not for resale. Your
        ...
        use of the content without the express written permission of Arti AI and
        ...
        express or implied, to the intellectual property of Arti AI or our
        licensors except as expressly authorized by these Terms. Use of
        Communication Services The Site may contain bulletin board services,
        chat areas, news groups, forums, communities, personal web pages,
        calendars, and/or other message or communication facilities designed to
        ...
        applicable laws or regulations. Arti AI has no obligation to monitor the
        Communication Services. However, Arti AI reserves the right to review
        materials posted to a Communication Service and to remove any materials
        in its sole discretion. Arti AI reserves the right to terminate your
        access to any or all of the Communication Services at any time without
        notice for any reason whatsoever. Arti AI reserves the right at all
        times to disclose any information as necessary to satisfy any applicable
        ...
        part, in Arti AI's sole discretion. Always use caution when giving out
        any personally identifying information about yourself or your children
        in any Communication Service. Arti AI does not control or endorse the
        content, messages or information found in any Communication Service and,
        therefore, Arti AI specifically disclaims any liability with regard to
        the Communication Services and any actions resulting from your
        participation in any Communication Service. Managers and hosts are not
        authorized Arti AI spokespersons, and their views do not necessarily
        reflect those of Arti AI. Materials uploaded to a Communication Service
        ...
        you upload the materials. Materials Provided to ArtiAI.com or Posted on
        Any Arti AI Web Page Arti AI does not claim ownership of the materials
        you provide to ArtiAI.com (including feedback and suggestions) or post,
        upload, input or submit to any Arti AI site or our associated services
        (collectively “Submissions”). However, by posting, uploading, inputting,
        providing or submitting your Submission you are granting Arti AI, our
        ...
        with your Submission. No compensation will be paid with respect to the
        use of your Submission, as provided herein. Arti AI is under no
        obligation to post or use any Submission you may provide and may remove
        any Submission at any time in Arti AI's sole discretion. By posting,
        ...
        upload, input or submit the Submissions. Third Party Accounts You will
        be able to connect your Arti AI account to third party accounts. By
        connecting your Arti AI account to your third party account, you
        ...
        by Arti AI from our offices within the USA. If you access the Service
        from a location outside the USA, you are responsible for compliance with
        all local laws. You agree that you will not use the Arti AI content
        accessed through ArtiAI.com in any country or in any manner prohibited
        by any applicable laws, restrictions or regulations. Indemnification You
        agree to indemnify, defend and hold harmless Arti AI, its officers,
        ...
        violation of any applicable laws, rules or regulations. Arti AI reserves
        the right, at its own cost, to assume the exclusive defense and control
        of any matter otherwise subject to indemnification by you, in which
        event you will fully cooperate with Arti AI in asserting any available
        defenses. Arbitration In the event the parties are not able to resolve
        ...
        dispute shall be resolved only by final and binding arbitration pursuant
        to the Federal Arbitration Act, conducted by a single neutral arbitrator
        and administered by the American Arbitration Association, or a similar
        ...
        of these Terms and Conditions. Class Action Waiver Any arbitration under
        these Terms and Conditions will take place on an individual basis; class
        arbitrations and class/representative/collective actions are not
        permitted. THE PARTIES AGREE THAT A PARTY MAY BRING CLAIMS AGAINST THE
        OTHER ONLY IN EACH’S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR
        ...
        AGAINST THE OTHER. Further, unless both you and Arti AI agree otherwise,
        ...
        THE INFORMATION HEREIN. Arti AI. AND/OR ITS SUPPLIERS MAY MAKE
        IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME. Arti AI AND/OR ITS
        ...
        PROVIDED “AS IS” WITHOUT WARRANTY OR CONDITION OF ANY KIND. Arti AI
        ...
        NON-INFRINGEMENT. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN
        NO EVENT SHALL Arti AI AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
        ...
        LIABILITY OR OTHERWISE, EVEN IF Arti AI OR ANY OF ITS SUPPLIERS HAS BEEN
        ...
        SITE. Termination/Access Restriction Arti AI reserves the right, in its
        sole discretion, to terminate your access to the Site and the related
        services or any portion thereof at any time, without notice. To the
        maximum extent permitted by law, this agreement is governed by the laws
        of the State of Florida and you hereby consent to the exclusive
        jurisdiction and venue of courts in Florida in all disputes arising out
        of or relating to the use of the Site. Use of the Site is unauthorized
        ...
        between you and Arti AI as a result of this agreement or use of the
        Site. Arti AI performance of this agreement is subject to existing laws
        and legal process, and nothing contained in this agreement is in
        derogation of Arti AI's right to comply with governmental, court and law
        enforcement requests or requirements relating to your use of the Site or
        information provided to or gathered by Arti AI with respect to such use.
        ...
        the entire agreement between the user and Arti AI with respect to the
        ...
        Arti AI with respect to the Site. A printed version of this agreement
        ...
        and all related documents be written in English. Changes to Terms Arti
        AI reserves the right, in its sole discretion, to change the Terms under
        which ArtiAI.com is offered. The most current version of the Terms will
        supersede all previous versions. Arti AI encourages you to periodically
