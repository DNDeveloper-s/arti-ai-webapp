...
export const FacebookAdVariantMiniShimmer = ({className = '', style = {}}) => {

	return (
		<div className={'ad-variant text-[7px] md:text-[35px] !p-0 ' + (className ?? '')} style={style}>
			...
			<div className="mb-[7px] px-[7px]">
				<span className="app-shimmer text-[6.65px] inline-flex leading-[10.5px]">Than you for providing that information, Saurabh, To better undersant yousfka sdlf jalsdf lajflj alsjf lajsdfl jaldf jlasdjf lasdf</span>
			</div>
			...
			<div className={"flex justify-between gap-[5.6px] items-center px-[7px] mt-[7px]"}>
				<span className={"app-shimmer text-[8.75px] leading-[9.1px]"}>This is a normal one liner where you can show one liner</span>
				<div className="flex-shrink-0">
					<span className="app-shimmer cursor-pointer rounded bg-gray-700 px-[4.2px] py-[3.5px] text-[7px]">Learn More</span>
				</div>
			</div>
