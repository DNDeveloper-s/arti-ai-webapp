...
export default function AdItem({messageItem, variantFontSize}: {messageItem: ChatGPTMessageObj, variantFontSize?: number}) {
	...
	const str = `<div class="">
		<div>
			<p class="text-white text-opacity-50 font-diatype text-[1em] leading-[1.6em] my-[0.4em]">Congratulations! We have
		...
		<div class="mt-[0.67em]">
			<span class="font-semibold text-primary text-[1.2em]">Ad Summary</span>
			<p
				class="text-white text-opacity-80 font-diatype text-[1em] leading-[1.6em] my-[0.55em]"><!-- Insert your JSON data here -->${json.summary}</p>
		</div>
		<div class="border-t border-gray-600 pt-3 mt-5">
			<ul class="list-disc px-4">
				<li class="text-white text-opacity-50 font-diatype text-[1em] leading-[1.6em] my-2">If you find the current
				...
				<li class="text-white text-opacity-50 font-diatype text-[1em] leading-[1.6em] my-2">Feel free to provide
