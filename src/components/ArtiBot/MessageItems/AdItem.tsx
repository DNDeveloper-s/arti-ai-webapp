		...
		<div className="">
			...
			<div className={"border-t border-gray-600 pt-3 mt-5"}>
				<ul className="list-disc px-4">
					<li className="text-white text-opacity-50 font-diatype text-base leading-[1.6em] my-2">If you find the current advertisement unsatisfactory, please feel free to share additional information with us. This will enable us to create a better ad for you, and you can easily generate a new one by clicking the 'Regenerate Ad' button.</li>
