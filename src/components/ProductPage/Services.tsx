...
interface Props {
  ...
  description: string;
  style?: any;
  serviceData: (typeof servicesData.cards)[0];
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <div ref={nodeRef} data-id={id}>
        {title}
        <p className="font-gilroyRegular  text-white leading-[22px] text-opacity-40 text-[15px]">
          {description}
        </p>
        <Button
          size="sm"
...
const Legacy_ArtiChatDemo: FC<ArtiChatDemoProps> = ({
  viewScreen,
  dimensions,
  sm,
  isMetric,
  ...
  const printAiMessage = useCallback(
    async (msg: string) => {
      await wait(1000);
  ...
  const demo = useCallback(async () => {
    ...
    if (!isAdCreative) {
      ...
      // return await demo();
      for (
        let i = isAdCreative ? 6 : 0;
        i < (isAdCreative ? _messages.length - 1 : _messages.length);
        i++
      ) {
      ...
      {mounted && adCreative && (
        ...
        >
          <div ref={rightPaneRef}>
            <RightPane
              mock={mockState}
              adCreative={mock.adCreative}
              style={{ position: "relative", zoom: 1, paddingLeft: 0 }}
            />
          </div>
        </div>
      )}
      {!adCreative && (
        ...
        >
          <div className={`flex h-full overflow-hidden`}>
            ...
            >
              <>
                <div className="flex justify-between h-auto py-2 px-6 box-border items-center bg-secondaryBackground shadow-[0px_1px_1px_0px_#000]">
                ...
                <AnimatePresence mode="wait">
                  <div
                    className={
                      ...
                      (showGetAdNowButton ? " pb-9 md:pb-10" : "")
                    }
                  >
                    {/*<ChatGPTMessageCreatingAd/>*/}
                    ...
                    <div className="w-full max-w-[900px] mx-auto px-3 flex justify-center items-center my-3">
                      ...
                      <div className="flex justify-center whitespace-nowrap items-center font-light text-xs font-diatype text-white text-opacity-50">
                        <span>Hey</span>
                        <Image
                          width={20}
                          height={20}
                ...
                <div className="flex w-full max-w-[900px] gap-3 mx-auto h-auto relative items-end pb-2 px-3 bg-secondaryBackground">
                  {showGetAdNowButton && !isGeneratingAd && (
                    <GetAdButton
                  ...
                  <div className="flex w-full max-w-[900px] mb-[-7px] mx-auto h-auto relative items-end bg-secondaryBackground">
                    <div className="w-full">
                      <TextareaAutosize
                        ...
                        onChange={(e) => {
                          areaRef.current &&
                            areaRef.current.scrollTo({ top: 20000, left: 0 });
          ...
          >
            <div ref={rightPaneRef}>
              <RightPane
                ...
                adCreative={mock.adCreative}
                style={{
                  opacity: publishingAd ? 0.3 : 1,
                  filter: `blur(${publishingAd ? 1 : 0}px)`,
                  position: "relative",
                  zoom: 1,
                  paddingLeft: 0,
                }}
              ...
              <div
                className={
                  "w-full flex justify-center items-center absolute bottom-2 left-1/2 -translate-x-1/2 z-10"
                }
              >
                <CTAButton
                  className={
                    "px-0 py-0 flex justify-center items-center h-8 w-36 gap-3 rounded-lg"
                  }
                >
                  {publishingAd ? (
                    <>
            ...
            <div className={`flex h-full overflow-hidden`}>
              ...
              >
                ...
                <div className={"flex px-3 py-1.5 gap-2.5 items-center"}>
                  <div
                    className={
                      "w-14 h-14 rounded flex justify-center items-center border-2 border-white border-opacity-25"
                    }
                  >
                    <Image
                ...
                <div className={"px-3.5 pb-2"}>
                  <h4 className={"text-[15px] font-semibold mb-2 text-white"}>
                    Results
                  </h4>
                ...
                {/*Graph*/}
                <div
                  className={"px-2 flex flex-1 justify-evenly flex-col gap-2"}
                >
                  <h4 className={"text-[12px]"}>
                    Cost per result is 14% lower than similar ad sets from peers
                  </h4>
                  <div>
                    <CanvasJSChart
                      options={options}
...
export default function Services() {
  ...
  const messages =
    idInView === 1
      ? (mockMessages as ChatGPTMessageObj[])
      : idInView === 2
        ? (mockAdCreativeMessages as ChatGPTMessageObj[])
        : [];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative md:sticky h-screen top-0 flex flex-col gap-3 justify-center items-center"
      >
        ...
        <div className="text-left w-[90vw] md:w-[550px] h-[80vh] flex items-center justify-center relative">
          <div
            className={
              "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[550px] flex justify-center items-center h-[80vh]"
            }
          >
            <Image
