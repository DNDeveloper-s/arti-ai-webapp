...
const Legacy_ServiceCard: React.FC<Props> = ({imageSrc, title, description, learnMore, style = {} }) => {
...
export default function Legacy_Services() {
	...
	return (
		<div id="product-overview" className="landing-page-section">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-20">
				{legacy_servicesData.cards.map(serviceItem => <Legacy_ServiceCard
					key={serviceItem.id}
