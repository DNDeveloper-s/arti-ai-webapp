...
const NavMobileItem = ({
  ...
  item: (typeof navbarData.navItems)[0];
  handleClose: () => void;
}) => {
      ...
      {hasChildren && (
        <div
          ...
          style={{
            ...
            boxShadow:
              "rgb(193 193 193 / 10%) 0px 20px 25px -5px, rgb(163 163 163 / 4%) 0px 10px 10px -5px",
          }}
        >
  ...
  return (
    <>
      <div className="absolute right-4 flex md:order-2">
        <Link
          className="breathing-button-primary rounded-lg"
          ...
          {data.navItems.map((item) => (
            <li className={"relative group"} key={item.id}>
              ...
              {item.children && item.children?.length > 0 && (
                <div
                  className={
                    "group-hover:opacity-100 opacity-0 pointer-events-none group-hover:pointer-events-auto absolute top-[100%] -left-2 rounded bg-black p-2"
                  }
                  style={{
                    boxShadow:
                      "rgb(193 193 193 / 10%) 0px 20px 25px -5px, rgb(163 163 163 / 4%) 0px 10px 10px -5px",
